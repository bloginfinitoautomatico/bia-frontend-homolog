            ...
            <div className="text-center py-12">
              ...
              <h3 className="font-poppins text-xl text-foreground mb-2">
                {filterStatus === 'all' 
                  ...
                  : filterStatus === 'ativa'
                    ? 'Nenhuma ideia ativa encontrada'
                    : filterStatus === 'produzido'
                      ? 'Nenhuma ideia produzida encontrada'
                      : 'Nenhuma ideia excluída encontrada'
                }
              </h3>
              <p className="font-montserrat text-muted-foreground mb-6">
                {filterStatus === 'all' 
                  ? 'Use os filtros acima para encontrar suas ideias' 
                  : filterStatus === 'ativa'
                    ? 'Não há ideias ativas no momento'
                    : filterStatus === 'produzido'
                      ? 'Ainda não há ideias produzidas'
